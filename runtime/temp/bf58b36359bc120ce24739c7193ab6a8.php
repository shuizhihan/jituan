<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:34:"../template/default/list_image.htm";i:1534905046;s:28:"../template/default\head.htm";i:1534120211;s:30:"../template/default\footer.htm";i:1533642598;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="met-product animsition type-0">
  <div class="container-fluid">
    <ul class="blocks-100 blocks-sm-1 blocks-md-2 blocks-xlg-2  met-page-ajax met-grid" id="met-grid" data-scale='0.66666666666667'>
      <?php if(is_array($artRes) || $artRes instanceof \think\Collection || $artRes instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($artRes) ? array_slice($artRes,0,6, true) : $artRes->slice(0,6, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?> 
      <li class=" shown padding-box">
        <div class="product-box">
          <div class="product-right"> <a href="<?php echo url('Article/index',array('aid'=>$vo['id'])); ?>" title="<?php echo $vo['title']; ?>" target='_self'> <img class="cover-image" src="__INDEX__/uploads/img/<?php echo $vo['litpic']; ?>"> </a> </div>
          <div class="product-left">
            <h3><a href="<?php echo url('Article/index',array('aid'=>$vo['id'])); ?>" title="<?php echo $vo['title']; ?>" target='_self'><?php echo $vo['title']; ?></a></h3>
            <p ><?php echo mb_substr($vo['description'],0,43,'utf-8'); ?>...</p>
            <div><a href="<?php echo url('Article/index',array('aid'=>$vo['id'])); ?>" title="<?php echo $vo['title']; ?>" target='_self'>点击进入<i class="fa fa-link"></i></a></div>
          </div>
        </div>
      </li>
      <?php endforeach; endif; else: echo "" ;endif; ?>
