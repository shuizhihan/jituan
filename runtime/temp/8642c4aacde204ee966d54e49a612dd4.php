<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\wamp64\www\jituan\public/../application/admin\view\adpos\list.htm";i:1534818888;s:69:"D:\wamp64\www\jituan\public/../application/admin\view\common\head.htm";i:1500202164;s:69:"D:\wamp64\www\jituan\public/../application/admin\view\common\left.htm";i:1534837893;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>新誉佳集团</title>
                        ...
                        <tbody>
                            <?php if(is_array($adposRes) || $adposRes instanceof \think\Collection || $adposRes instanceof \think\Paginator): $i = 0; $__LIST__ = $adposRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$adpos): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="<?php echo url('Adpos/edit',array('id'=>$adpos['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('Adpos/del',array('id'=>$adpos['id'])); ?>')" class="btn btn-danger btn-sm shiny">
