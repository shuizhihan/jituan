<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\wamp64\www\jituan\public/../application/admin\view\content\list.htm";i:1534818871;s:69:"D:\wamp64\www\jituan\public/../application/admin\view\common\head.htm";i:1500202164;s:69:"D:\wamp64\www\jituan\public/../application/admin\view\common\left.htm";i:1534837893;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>新誉佳集团</title>
	...
	<div class="main-container container-fluid">
		<div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-body">
<?php if($modelId != 0): ?>                  
<button type="button" tooltip="添加文档" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Content/add',['cate_id'=>$cateId,'model_id'=>$modelId]); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<?php endif; ?>
<div class="row">
                        ...
                        <tbody>
                            <?php if(is_array($artRes) || $artRes instanceof \think\Collection || $artRes instanceof \think\Paginator): $i = 0; $__LIST__ = $artRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$art): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td align="center"><?php echo $art['model_name']; ?></td>
                                    <td align="center">
                                        <a href="<?php echo url('edit',array('art_id'=>$art['id'],'model_id'=>$art['model_id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('art_id'=>$art['id'],'model_id'=>$art['model_id'])); ?>')" class="btn btn-danger btn-sm shiny">
