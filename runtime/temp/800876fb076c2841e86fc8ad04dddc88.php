<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"../template/default/index_article.htm";i:1534905012;s:28:"../template/default\head.htm";i:1534120211;s:30:"../template/default\footer.htm";i:1533642598;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
...
<meta name="generator" data-variable="19,19,1"/>
<title><?php echo $cates['title']; ?></title>
...
<div class="banner-box">
  <div class="met-banner banner-ny-h" data-height='' style='background-color:#023894;'>
    <div class="slick-slide"> <img class="cover-image" src="/template/default/skin/images/about.jpg" srcset='/template/default/skin/images/about.jpg' data-page-img='/template/default/skin/images/about.jpg' sizes="(max-width: 767px) 767px" alt="<?php echo $cates['title']; ?>"> </div>
  </div>
</div>
...
<section class="met-show animsition">
  <div class="container-fluid">
    <div class="padding-box">
      <div class="lazyload clearfix" style="background:#FFF;padding:30px;"> <?php echo $cates['content']; ?> </div>
    </div>
  </div>
</section>
<footer>
